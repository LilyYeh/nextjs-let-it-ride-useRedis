...
import { createPlayer, removePlayers, getAllPlayers, countPlayers } from "./redis_player";
...
export async function login(socketId, baseMoney, baseMyMoney) {
	...
	const insertSQL = `INSERT INTO players (socketId, name, isCurrentPlayer, money, bankerId) VALUES ('${socketId}', '玩家1', ${isCurrentPlayer}, ${money}, ${bankerId})`;
	await query({ query: insertSQL });

	// instert redis
	await createPlayer({socketId:socketId, isCurrentPlayer:isCurrentPlayer, money:money});
